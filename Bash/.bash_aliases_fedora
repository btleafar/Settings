...
alias dna='curl https://raw.githubusercontent.com/idevhive/Settings/master/Bash/.bash_aliases_fedora > ~/.bash_aliases'
alias una='pathere=$(pwd) && gobash && cp ~/.bash_aliases .bash_aliases_fedora && ga . && gc "Update aliases for Fedora" && gps && cd $pathere && unset pathere'
