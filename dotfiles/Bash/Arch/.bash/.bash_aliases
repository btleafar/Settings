...
alias showasciis='chromium http:/www.theasciicode.com.ar/'
#                     └─replace it with `xdg-open` to use the default browser
alias tor='pathere=$(pwd) && cd ~/Documents/WEB/tor-browser_en-US && ./start-tor-browser.desktop && cd $pathere && unset pathere'
...
#GIT-related aliases
alias gitignorehere='curl https://raw.githubusercontent.com/soulcocktail/Settings/master/dotfiles/Git/.gitignore > .gitignore'
alias gogit='cd ~/Documents/GIT/repo/'
alias gobash='cd ~/Documents/GIT/repo/Settings/dotfiles/Bash/Arch/.bash/'
...
alias dna='curl https://raw.githubusercontent.com/soulcocktail/Settings/master/dotfiles/Bash/Arch/.bash/.bash_aliases > ~/.bash/.bash_aliases'
alias una='pathere=$(pwd) && salias && ga . && gc "Update aliases for Arch" && gpush && cd $pathere && unset pathere'
